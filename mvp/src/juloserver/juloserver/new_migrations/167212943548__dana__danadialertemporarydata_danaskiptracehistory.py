# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2022-12-27 08:23
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='DanaDialerTemporaryData',
            fields=[
                ('cdate', models.DateTimeField(auto_now_add=True)),
                ('udate', models.DateTimeField(auto_now=True)),
                ('id', models.AutoField(db_column='dana_dialer_temporary_id', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DanaSkiptraceHistory',
            fields=[
                ('cdate', models.DateTimeField(auto_now_add=True)),
                ('udate', models.DateTimeField(auto_now=True)),
                ('id', models.AutoField(db_column='dana_skiptrace_history_id', primary_key=True, serialize=False)),
                ...
                ('agent', cuser.fields.CurrentUserField(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='dana_skiptrace_call_history', to=settings.AUTH_USER_MODEL)),
