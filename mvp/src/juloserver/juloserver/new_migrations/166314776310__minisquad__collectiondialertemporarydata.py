# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2022-09-14 09:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='CollectionDialerTemporaryData',
            fields=[
                ('cdate', models.DateTimeField(auto_now_add=True)),
                ('udate', models.DateTimeField(auto_now=True)),
                ('id', models.AutoField(db_column='collection_dialer_temporary_id', primary_key=True, serialize=False)),
