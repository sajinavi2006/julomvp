# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2021-08-05 05:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', juloserver.julocore.customized_psycopg2.models.BigForeignKey(blank=True, db_column='device_id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='julo.Device')),
                ('face_search_result', models.ForeignKey(db_column='face_search_result_id', on_delete=django.db.models.deletion.DO_NOTHING, to='face_recognition.FaceSearchResult')),
            ],
            options={
