--DROP VIEW IF EXISTS ops.fdc_data_as_view_v2; using this when changing or adding column name
...
ALTER TABLE ops.fdc_data_as_view_v3 OWNER TO postgres;
GRANT ALL ON TABLE ops.fdc_data_as_view_v3 TO postgres;
GRANT SELECT ON TABLE ops.fdc_data_as_view_v3 TO readonly_users;
GRANT SELECT ON TABLE ops.fdc_data_as_view_v3 TO analytics_users;
GRANT ALL ON TABLE ops.fdc_data_as_view_v3 TO admin_users;
GRANT ALL ON TABLE ops.fdc_data_as_view_v3 TO ops_server;
