...
class TestPaymentQuerySet(TestCase):
    def setUp(self):
    ...
    def test_get_data_bucket_1(self):
        ...
        payments = Payment.objects.get_queryset().get_bucket_1()
    ...
    def test_get_data_bucket_2(self):
        ...
        payments = Payment.objects.get_queryset().get_bucket_2()
        self.assertEqual(len(payments), 1)
    ...
    def test_get_data_bucket_3(self):
        ...
        payments = Payment.objects.get_queryset().get_bucket_3()
        self.assertEqual(len(payments), 1)
    ...
    def test_get_data_bucket_4(self):
        ...
        payments = Payment.objects.get_queryset().get_bucket_4()
        self.assertEqual(len(payments), 1)
    ...
    def test_get_data_bucket_5(self):
        ...
        payments = Payment.objects.get_queryset().get_bucket_5()
        self.assertEqual(len(payments), 1)
    ...
    def test_determine_bucket_by_range(self):
        ...
        range_dpd_bucket_1 = today - timedelta(days=BucketConst.BUCKET_1_DPD['from'])
        Payment.objects.last().update_safely(due_date=range_dpd_bucket_1)
        payments = Payment.objects.get_queryset().determine_bucket_by_range([
