...
class Command(BaseCommand):
    help = 'blast email for early payment collections'
    ...
    def handle(self, *args, **options):
        ...
        if api_key == "--------------------------------sendgrid_API_KEY----------------------":
            ...
            return
        folder = '../../email_blast/blast_coll_campaign_sept_21/'
            ...
            for index, row in enumerate(listemail):
                ...
                if row_splited[0].strip() != "variant":
                    ...
                    if not processed_row:
                        ...
                        try:
                            status, headers, subject, content = julo_email_client.email_coll_campaign_sept_21_blast(email, variant, fullname)
                        except EmailNotSent:
