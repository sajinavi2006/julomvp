...
class Command(BaseCommand):
    help = 'blast sms for upgrade buggy apk'

    def handle(self, *args, **options):
        folder = '../../email_blast/blast_upgrade_buggy_apk_sms/'
        ...
        for file in files:
            ...
            for index, row in enumerate(listphonenumber):
                ...
                if row_splited[0].strip() != "variant":
                    ...
                    text = "Pelanggan JULO! UPDATE aplikasi JULO Anda ke versi terbaru v2.3.1 disini bit.ly/juloapp utk kelancaran pengajuan pinjaman dan proses verifikasi yg lebih cepat."
                    try:
                        row_splited[18]
