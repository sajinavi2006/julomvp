...
class Command(BaseCommand):
            ...
            for row in rows:
                try:
                    ...
                    if not application:
                        ...
                        continue
                    self.run_send_warning_letters(application, row['send_date'])
    ...
    def run_send_warning_letters(self, application, send_date):
        ...
        for payment in payments:
            ...
            if late_payment_count > 0:
                ...
                try:
                    self.email_warning_letters(payment, due_payments, wl_level, send_date)
                except Exception as e:
                    logger.error({
    ...
    def email_warning_letters(self, loan, due_payment, warning_type, send_date):
        loan = loan.loan
        ...
        template_correction_name = 'wl3_correction.html'
