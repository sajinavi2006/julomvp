...
def create_new_workflow_path_from_120_to_141(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('julo', '0464_workflow_new_path_from_141_to_172'),
    ]

    operations = [
        migrations.RunPython(create_new_workflow_path_from_120_to_141),
    ]