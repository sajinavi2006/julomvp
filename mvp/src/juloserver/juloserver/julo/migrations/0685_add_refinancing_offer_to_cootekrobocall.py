...
def retro_cootek_data_for_task_type(apps, _schema_editor):
    ...
    CootekRobocall = apps.get_model("julo", "CootekRobocall")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('julo', '0684_retroload_fdc_risky_history'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, db_column='loan_refinancing_offer',
                null=True, on_delete=django.db.models.deletion.DO_NOTHING,
                to='loan_refinancing.LoanRefinancingOffer'),
        ),
        migrations.AddField(
            model_name='cootekrobocall',
            name='task_type',
