...
class CashLoanSchema(object):
    NAME = 'CashLoanWorkflow'
    DESC = 'this is a workflow for cash loan '
    ...
    happy_paths = (
        ...
        },
        {
            ...
            'allowed_paths': (
                ...
                {
                    # happy path 122 for parallel high score bypass experiment
        ...
        {
            # 1220
            'origin_status': ApplicationStatusCodes.DOCUMENTS_VERIFIED_BY_THIRD_PARTY,
            'allowed_paths': (
                {
                    # happy path
                    'end_status': ApplicationStatusCodes.VERIFICATION_CALLS_SUCCESSFUL_BY_THIRD_PARTY,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[0]
                },
                {
                    # detour
                    'end_status': ApplicationStatusCodes.VERIFICATION_CALLS_ONGOING_BY_THIRD_PARTY,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[0]
                },
        ...
        {
            # 1240
            'origin_status': ApplicationStatusCodes.VERIFICATION_CALLS_SUCCESSFUL_BY_THIRD_PARTY,
            'allowed_paths': (
                {
                    # happy path
                    'end_status': ApplicationStatusCodes.APPLICANT_CALLS_SUCCESSFUL,
        ...
        },
        {
            ...
            'allowed_paths': (
                {
                    'end_status': ApplicationStatusCodes.ACTIVATION_CALL_SUCCESS_AND_BANK_VALIDATE_ONGOING,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[0]
                },
        ...
        {
            # 145
            'origin_status': ApplicationStatusCodes.DIGISIGN_FAILED,
            'allowed_paths': (
                {
        ...
        {
            # 147
            'origin_status': ApplicationStatusCodes.DIGISIGN_FACE_FAILED,
            'allowed_paths': (
                {
                    'end_status': ApplicationStatusCodes.ACTIVATION_CALL_SUCCESS_AND_BANK_VALIDATE_ONGOING,
                    'customer_accessible': False,
        ...
        {
            # 150
            'origin_status': ApplicationStatusCodes.ACTIVATION_CALL_SUCCESS_AND_BANK_VALIDATE_ONGOING,
            'allowed_paths': (
                {   # 160
                    'end_status': ApplicationStatusCodes.ACTIVATION_CALL_SUCCESSFUL,
                    'customer_accessible': False,
        ...
        },
        {
            ...
            'allowed_paths': (
                ...
                {
                    'end_status': ApplicationStatusCodes.BULK_DISBURSAL_ONGOING,
                    'customer_accessible': False,
                    'agent_accessible': False,
                    'type': PATH_TYPES[0]
                },
        ...
        {
            # 178
            'origin_status': ApplicationStatusCodes.BULK_DISBURSAL_ONGOING,
            'allowed_paths': (
                {
                    'end_status': ApplicationStatusCodes.FUND_DISBURSAL_SUCCESSFUL,
                    'customer_accessible': False,
        ...
        {
            # 1380
            'origin_status': ApplicationStatusCodes.VERIFICATION_CALLS_ONGOING_BY_THIRD_PARTY,
            'allowed_paths': (
                {
                    # happy path
                    'end_status': ApplicationStatusCodes.VERIFICATION_CALLS_SUCCESSFUL_BY_THIRD_PARTY,
        ...
        {
            # 1311
            'origin_status': ApplicationStatusCodes.FACE_RECOGNITION_AFTER_RESUBMIT,
            'allowed_paths': (
                {
                    'end_status': ApplicationStatusCodes.SCRAPED_DATA_VERIFIED,
                    'customer_accessible': False,
    ...
    detour_paths = (
        ...
        },
        {
            ...
            'allowed_paths': (
                ...
                {
                    'end_status': ApplicationStatusCodes.DIGISIGN_FACE_FAILED,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[1]
                },
        ...
        },
        {
            ...
            'allowed_paths': (
                ...
                {
                    'end_status': ApplicationStatusCodes.DIGISIGN_FAILED,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[1]
                },
        ...
        },
        {
            ...
            'allowed_paths': (
                ...
                {
                    'end_status': ApplicationStatusCodes.FACE_RECOGNITION_AFTER_RESUBMIT,
                    'customer_accessible': False,
                    'agent_accessible': True,
                    'type': PATH_TYPES[1]
                },
    ...
    status_nodes = (
        {
            ...
            'handler': 'CashLoanWorkflowNode163Handler'
        },
        {
            # 150
            'destination_status': ApplicationStatusCodes.ACTIVATION_CALL_SUCCESS_AND_BANK_VALIDATE_ONGOING,
            'handler': 'CashLoanNode150Handler'
        },
    )
