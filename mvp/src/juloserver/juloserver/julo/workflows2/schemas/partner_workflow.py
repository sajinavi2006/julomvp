...
class PartnerWorkflowSchema(object):
    NAME = 'PartnerWorkflow'
    DESC = 'this is a workflow for partner intregration '
    ...
    happy_paths = (
        {
            ...
            'allowed_paths': (
                ...
                {
                    # happy path, pre app revamp
                    'end_status': ApplicationStatusCodes.FORM_GENERATED,
                    'customer_accessible': False,
        ...
        {
            # 148
            'origin_status': ApplicationStatusCodes.FORM_GENERATED,
            'allowed_paths': (
                {
    ...
    status_nodes = (
        {
            ...
            'handler': 'PartnerNode105Handler'
        },
        {
            # 148
            'destination_status': ApplicationStatusCodes.FORM_GENERATED,
            'handler': 'PartnerNode148Handler'
        },
        {
            # 178
            'destination_status': ApplicationStatusCodes.BULK_DISBURSAL_ONGOING,
            'handler': 'PartnerNode178Handler'
        },
    )
