...
class Command(BaseCommand):
    help = 'retroload data b5 existing on vendor sakinah insert to collection assignment vendor'

    def handle(self, *args, **options):
        csv_file_name = 'misc_files/csv/payments_assign_to_vendor_sakinah.csv'
        ...
        try:
            ...
            for row in rows:
                ...
                collection_vendor = CollectionVendor.objects.filter(
                    vendor_name='Sakinah Sahabat Senter'
                ).last()
