...
class Command(BaseCommand):
    help = 'retroload data b5 existing on vendor xing hao insert to collection assignment vendor'

    def handle(self, *args, **options):
        csv_file_name = 'misc_files/csv/payments_assign_to_vendor_xinghao.csv'
