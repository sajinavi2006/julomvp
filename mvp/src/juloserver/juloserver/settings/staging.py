...
PAYMENT_DETAILS = "https://cms-staging.julo.co.id/payment_detail/"
WARNING_LETTER = "https://web-dev.julo.co.id/warning_letter/staging/"
JULO_WEB_URL = "https://app-staging.julo.co.id"
...
# Newsletter
CMS_FILES_NEWLATTER = "https://cms-staging.julo.co.id/sites/default/files/newsletter/"

MAGIC_LINK_BASE_URL = "https://web-dev.julo.co.id/magic_link/staging/"
...
DATADOG_TRACE['DEFAULT_SERVICE'] = SERVICE_DOMAIN + '-api'
DATADOG_TRACE['DEFAULT_CACHE_SERVICE'] = SERVICE_DOMAIN + '-cache'
DATADOG_TRACE['DEFAULT_DATABASE_PREFIX'] = SERVICE_DOMAIN + '-'
#celery
patch(celery=True)
tracer.set_tags({
    'env': ENVIRONMENT,
...
# CELERY_ROUTES['send_email_otp_token'] = {'queue': 'customer_normal',
#                                          'routing_key': 'customer_normal'}
...
CACHEOPS.update(
    {
        'cfs.CfsAction': {'ops': 'all', 'timeout': 60},
        'cfs.CfsTier': {'ops': 'get', 'timeout': 10},
    }
)


MISSION_WEB_URL = "https://cms-staging.julo.co.id"
