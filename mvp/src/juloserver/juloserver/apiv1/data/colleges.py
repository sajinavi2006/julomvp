...
COLLEGE_LIST = [
    ...
    (
        "Jakarta,Universitas Islam Negeri Syarif Hidayatullah Jakarta (UIN Syarif Hidayatullah) "
        "- Jakarta"
    ),
    ...
    "Jakarta,Universitas Persada Indonesia Yayasan Administrasi Indonesia (UPI Y.A.I) - Jakarta",
    ...
    "Jawa Timur,Universitas Islam Negeri Maulana Malik Ibrahim Malang (UIN-Malang) - Jawa Timur",
    ...
    (
        "Kepulauan Riau,Sekolah Tinggi Agama Islam Negeri Tanjung Pinang (STAIN Tanjung Pinang) "
        "- Kepulauan Riau"
    ),
    ...
    (
        "Sulawesi Selatan,Sekolah Tinggi Ilmu Manajemen Lembaga Pendidikan Indonesia (STIM LPI) "
        "- Sulawesi Selatan"
    ),
    ...
    (
        "Yogyakarta,Universitas Pembangunan Nasional Veteran Yogyakarta (UPN Veteran Yogyakarta) "
        "- Yogyakarta"
    ),
