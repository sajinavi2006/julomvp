...
from juloserver.julo.models import PaymentMethod, GlobalPaymentMethod, FeatureSetting
...
from juloserver.standardized_api_response.utils import (
    general_error_response, success_response)
...
class PaymentMethodRetrieveView(StandardizedExceptionHandlerMixin, APIView):
    def get(self, request, account_id):
        ...
        payment_methods = PaymentMethod.objects.filter(
            customer=customer, is_shown=True).order_by('sequence')
