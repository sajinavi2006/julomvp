...
class TestBlacklistedGeohash5List(APITestCase):
    def setUp(self):
        ...
        with patch('django.utils.timezone.now', return_value=self.current_datetime):
            self.fraud_blacklisted_geohash5 = FraudBlacklistedGeohash5Factory(
                geohash5='wxyz'
            )


    def test_get_list(self):
        url = '/api/fraud-portal/blacklisted-geohash5s'
        ...
        expected_result = {
            ...
            "data": {
                ...
                "data": [
                    {
                        "fraud_blacklisted_geohash5_id": self.fraud_blacklisted_geohash5.id,
                        "geohash5": "wxyz",
    ...
    def test_add_data(self):
        ...
        expected_result = {
            ...
            "data": [
                {
                    "fraud_blacklisted_geohash5_id": 1,
                    "geohash5": "abcd",
        ...
        response['data'][0].pop('fraud_blacklisted_geohash5_id', None)
        expected_result['data'][0].pop('fraud_blacklisted_geohash5_id', None)
        self.assertEqual(response, expected_result)


    def test_delete_data(self):
        url = '/api/fraud-portal/blacklisted-geohash5s/'+str(self.fraud_blacklisted_geohash5.id)
