...
class TestBlacklistedGeohash5List(APITestCase):
    ...
    def test_get_list(self):
        url = '/api/fraud-portal/suspicious-asns'
                ...
                "data": [
                    {
                        ...
                        "fraud_high_risk_asn_id": self.high_risk_asn.id
                    }
                ]
            },
            "errors": []
    ...
    def test_add_data(self):
        ...
        response['data'][0].pop('fraud_high_risk_asn_id', None)
        expected_result['data'][0].pop('fraud_high_risk_asn_id', None)
        self.assertEqual(response, expected_result)


    def test_delete_data(self):
        url = '/api/fraud-portal/suspicious-asns/?id='+str(self.high_risk_asn.id)+'&name=asn123'
    ...
    def test_upload_data(self):
        ...
        url = '/api/fraud-portal/suspicious-asns/upload'
