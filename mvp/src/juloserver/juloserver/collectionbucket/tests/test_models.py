...
class TestModels(TestCase):
    ...
    def test_collection_agent_assignment_manager(self):
        CollectionAgentTask.objects.get_bucket_2_data()
        CollectionAgentTask.objects.get_bucket_3_data()
        CollectionAgentTask.objects.get_bucket_4_data()
        CollectionAgentTask.objects.get_bucket_5_data()
        CollectionAgentTask.objects.get_bucket_2_vendor()
        CollectionAgentTask.objects.get_bucket_3_vendor()
        CollectionAgentTask.objects.get_bucket_4_vendor()