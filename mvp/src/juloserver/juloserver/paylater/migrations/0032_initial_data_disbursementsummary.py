...
def insert_data_disbursementsummary(apps, schema_editor):
    ...
    TransactionOne = apps.get_model("paylater", "TransactionOne")
    DisbursementSummary = apps.get_model("paylater", "DisbursementSummary")
...
class Migration(migrations.Migration):
    dependencies = [
        ('paylater', '0031_disbursementsummary_disburse_xid'),
    ]
