# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2023-06-05 09:03
...
# Setup values
PRODUCT_NAME = 'j1'
DESCRIPTION_STREAM = 'retroload_for_j1_info_card'


class ImageNames(object):
    BACKGROUND = 'info-card/bg_for_info_text.png'
...
def retroload_infocard_julo_turbo(_apps, _schema_editor):
    ...
    data_to_be_loaded = [
        {
            'status': 127,
            'additional_condition': CardPropertyConst.TYPO_CALLS_UNSUCCESSFUL,
            'title': 'Angkat Telepon dari Pihak JULO, Ya 📞',
            'content': 'Pastikan nomor HP kamu aktif untuk memastikan datamu sudah sesuai dan benar '
