# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-02-05 07:33
...
def retroload_cards_data_grab(_apps, _schema_editor):
    data = {
        ...
        'additional_condition': 'GRAB_FAILED_3MAX_CREDITORS_CHECK',
        'title': 'Lunasi Pinjaman Lain Dulu, Yuk!',
        'content': '<p>Pinjaman kamu sudah disetujui, Nam belum bisa digunakan karena '
                   'jumlah pinjaman aktif kamu saat ini melebihi batas aturan OJK.</p> '
                   '<p><strong>Baca Lebih Lanjut</strong> untuk info selengkapnya, ya!</p>',
        'button': ['Baca Lebih Lanjut'],
        'button_name': [M_BUTTON],
        'click_to': ['/3max_creditor_bottom_sheet'],
        'template_type': '2',
        'card_number': 1,
        'text_colour': '#ffffff',
        'title_colour': '#ffffff',
