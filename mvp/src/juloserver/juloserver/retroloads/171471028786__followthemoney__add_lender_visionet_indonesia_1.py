# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-05-03 04:24
...
def add_visionet_indonesia_1_lender(apps, schema_editor):
...
def update_list_lender_info_fs_for_lender_visionet_indonesia_1(apps, schema_editor):
...
def create_new_certificate_for_lender_visionet_indonesia_1(apps, schema_editor):
    v1_lender = LenderCurrent.objects.get_or_none(lender_name=USERNAME)
    if v1_lender:
        generate_lender_signature(lender=v1_lender, signature_key='lender')


def update_signature_key_configuration_for_lender_visionet_indonesia_1(apps, schema_editor):
    feature_setting = FeatureSetting.objects.filter(
    ...
    v1_lender = LenderCurrent.objects.get_or_none(lender_name=USERNAME)
    if v1_lender:
        feature_setting.parameters['users'][str(v1_lender.user.id)] = 'lender'
        feature_setting.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=add_visionet_indonesia_1_lender,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_list_lender_info_fs_for_lender_visionet_indonesia_1,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=create_new_certificate_for_lender_visionet_indonesia_1,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_signature_key_configuration_for_lender_visionet_indonesia_1,
            reverse_code=migrations.RunPython.noop,
        ),
    ]
