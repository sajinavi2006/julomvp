    ...
    data_to_be_loaded = [
        {
            ...
            'additional_condition': 'GRAB_INFO_CARD',
            'title': 'Lanjutkan Pengajuan Anda',
            'content': 'Formulir pengajuan Anda belum selesai, silahkan lanjutkan pengisian sekarang',
            'button': ['Lanjuthan isi Formulir'],
            'button_name': [M_BUTTON],
            'click_to': ['/application/personal_identity'],
            'template_type': '2',
            'card_number': 1,
            'text_colour': '#ffffff',
            'title_colour': '#ffffff',
        ...
        },
        {
            ...
            'content': 'Data pengajuan Anda telah diterima '
                       'dan sedang diverifikasi. Silahkan kembali '
                       'dalam satu hari kerja untuk memeriksa status pengajuan Anda.',
            'button': [],
            'click_to': [],
            'template_type': '2',
            'card_number': 1,
        ...
        {
            'status': ApplicationStatusCodes.FORM_PARTIAL_EXPIRED,
            'additional_condition': 'GRAB_INFO_CARD_BAD_HISTORY',
            'title': 'Mohon maaf🙏🏻',
        ...
        },
        {
            ...
            'additional_condition': 'GRAB_INFO_CARD',
            'title': '⚠️Data Anda belum lengkap⚠️',
            'content': 'Silahkan kembali ke proses pengajuan dengan mengunggah '
                       'foto-foto dokumen yang masih kurang.',
            'button': ["Lengkapi"],
            'button_name': [M_BUTTON],
            'click_to': ["/upload_photo"],
            'template_type': '2',
            'card_number': 1,
            'text_colour': '#ffffff',
            'title_colour': '#ffffff',
        ...
        },
        {
            ...
            'additional_condition': 'GRAB_INFO_CARD',
            'title': 'Mohon maaf🙏🏻',
            'content': 'Permohonan Anda belum dapat disetujui untuk saat ini '
                       'karena belum memenuhi kriteria yang ada.',
            'button': ["Ajukan Kembali"],
            'button_name': [M_BUTTON],
            'click_to': ["/application/personal_identity"],
            'template_type': '2',
        ...
        {
            'status': ApplicationStatusCodes.APPLICATION_DENIED,
            'additional_condition': 'GRAB_INFO_CARD_REAPPLY',
        ...
        },
        {
            ...
            'content': 'Unggahan foto Anda belum berhasil. Yuk, unggah '
                       'kembali fotonya untuk melanjutkan proses!',
            'button': ['Privy'],
            'click_to': ['/upload_photo'],
            'button_name': [M_BUTTON],
            'template_type': '2',
        ...
        },
        {
            ...
            'additional_condition': 'GRAB_INFO_CARD',
            'title': 'Mohon Menunggu',
            'content': 'Dana pinjaman sedang diproses dan akan ditransfer ke '
                       'rekening tujuan. Mohon menunggu maks. 1x24 jam.',
            'button_name': [],
            'button': [],
            'click_to': [],
            'template_type': '2',
        ...
        },
        {
            ...
            'additional_condition': 'GRAB_INFO_CARD',
            'title': 'Mohon Menunggu',
            'content': 'Dana pinjaman sedang diproses dan akan ditransfer ke rekening '
                       'tujuan. Mohon menunggu maks. 1x24 jam.',
            'button_name': [],
            'button': [],
            'click_to': [],
            'template_type': '2',
