# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2022-12-23 06:43
...
def create_fama_lender(apps, schema_editor):
    ...
    if not partner:
        ...
        lender = LenderCurrent.objects.create(
            ...
            poc_position="-",
            source_of_fund="lainnya",
            lender_display_name='FAMA Channeling',
            service_fee=0,
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_fama_lender, migrations.RunPython.noop),
    ]
