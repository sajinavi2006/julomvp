...
def add_healthcare_voice_record_and_signature_threshold(apps, schema_editor):
    METHOD_ID = 15
...
def update_feature_otp_transaction_flow(apps, schema_editor):
    ...
    if 'transaction_healthcare' not in parameters:
        parameters.update({
            "transaction_healthcare": "long_lived",
        })
    feature_setting.parameters = parameters
    feature_setting.save()


def update_feature_setting_for_transaction_otp_healthcare(apps, schema_editor):
    ...
    transaction_settings['transaction_healthcare'] = {
        "is_active": True,
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_healthcare_voice_record_and_signature_threshold),
        migrations.RunPython(update_feature_otp_transaction_flow),
        migrations.RunPython(update_feature_setting_for_transaction_otp_healthcare),
    ]
