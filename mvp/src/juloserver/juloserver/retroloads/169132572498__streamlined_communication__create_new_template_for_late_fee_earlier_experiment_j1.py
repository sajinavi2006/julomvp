...
def add_nexmo_robocall_for_late_fee_earlier_experiment_j1(apps, schema_editor):
    ...
    with transaction.atomic():
        ...
        StreamlinedCommunication.objects.create(
            ...
            template_code="nexmo_robocall_j1_-5",
            dpd=-5,
            type=VoiceTypeStatus.PAYMENT_REMINDER,
            product="nexmo_turbo",
            is_automated=True,
            description="J1 customer who have t-5",
        ...
        StreamlinedCommunication.objects.create(
            ...
            product="nexmo_turbo",
            is_automated=True,
            description="nexmo robocall for calling t-3 j1 customer",
            function_name="{send_voice_account_payment_reminder,"\
                "retry_send_voice_account_payment_reminder1,"\
                "retry_send_voice_account_payment_reminder2}",
        ...
        StreamlinedCommunication.objects.create(
            ...
            communication_platform=CommunicationPlatform.ROBOCALL,
            template_code="nexmo_robocall_j1_4",
            dpd=4,
            type=VoiceTypeStatus.PAYMENT_REMINDER,
            product="nexmo_turbo",
            is_automated=True,
            description="nexmo robocall for j1 customer at dpd 4",
            function_name="{send_voice_account_payment_reminder,"\
                "retry_send_voice_account_payment_reminder1,"\
                "retry_send_voice_account_payment_reminder2}",
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_nexmo_robocall_for_late_fee_earlier_experiment_j1,
