# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-04-05 10:28
...
METHOD_ID = TransactionMethodCode.INTERNET_BILL.code
TOKEN_ACTION = SessionTokenAction.TRANSACTION_INTERNET_BILL


def add_internet_bill_transaction_method(app, schema_editor):
    bucket_url = settings.STATIC_ALICLOUD_BUCKET_URL + "internet_bill/"
    TransactionMethod.objects.get_or_create(
        id=METHOD_ID,
        defaults=dict(
            method=TransactionMethodCode.INTERNET_BILL.name,
            fe_display_name="Bayar Internet",
            background_icon_url=bucket_url + "internet_bill.gif",
            foreground_icon_url=bucket_url + "internet_bill.png",
            foreground_locked_icon_url=bucket_url + "internet_bill_locked.png",
        ),
    )


def update_mobile_fs_trx_method_highlight_for_internet_bill(apps, schema_editor):
...
def update_mobile_fs_product_lock_for_internet_bill(apps, schema_editor):
    ...
    if mobile_fs_product_lock:
        mobile_fs_product_lock.parameters[LoanJuloOneConstant.INTERNET_BILL] = {
            "locked": True,
            "app_version": "99.0.0",
        }
...
def update_fs_trx_method_limit_for_internet_bill(apps, schema_editor):
    ...
    if fs_trx_method_limit:
        fs_trx_method_limit.parameters[TransactionMethodCode.INTERNET_BILL.name] = {
            "24 hr": 10,
            "1 hr": 5,
            "5 min": 1,
            "is_active": True,
...
def add_internet_bill_voice_record_and_signature_threshold(apps, schema_editor):
...
def update_fs_otp_action_type_for_internet_bill(apps, schema_editor):
...
def update_mobile_fs_otp_setting_for_internet_bill(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            code=add_internet_bill_transaction_method,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_mobile_fs_trx_method_highlight_for_internet_bill,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_mobile_fs_product_lock_for_internet_bill,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_fs_trx_method_limit_for_internet_bill,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=add_internet_bill_voice_record_and_signature_threshold,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_fs_otp_action_type_for_internet_bill,
            reverse_code=migrations.RunPython.noop,
        ),
        migrations.RunPython(
            code=update_mobile_fs_otp_setting_for_internet_bill,
            reverse_code=migrations.RunPython.noop,
        ),
    ]
