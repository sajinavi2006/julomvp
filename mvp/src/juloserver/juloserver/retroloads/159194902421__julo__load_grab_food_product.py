...
def load_loc_product(apps, schema_editor):
    if ProductLookup.objects.last():
        last_id = ProductLookup.objects.latest('product_code').product_code
        query = 'ALTER SEQUENCE product_lookup_product_code_seq RESTART WITH {}'.format(last_id + 1)
    ...
    for GRAB_FOOD_PRODUCT in GRAB_FOOD_PRODUCTS:
        ...
        for product_lookup_data in product_lookup_list:
            ...
            ProductLookup.objects.create(**product_lookup)
