...
class ImageNames(object):
    ...
    IMG = 'info-card/CARD_OPTIONAL_IMAGE_WEB190.png'
    BTN = 'info-card/R_BUTTON_IMAGE_WEB190.png'
    ...
    data_to_be_loaded = [
        {
            ...
            'additional_condition': 'J1_LIMIT_LESS_THAN_TURBO',
            'title': 'Asik, Upgrade Akun Berhasil, Nih!',
            ...
            'additional_images': [ImageNames.IMG],
