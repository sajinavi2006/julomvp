# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2025-04-24 06:11
...
def dukcapil_fr_threshold_leadgen_axiata(apps, _schema_editor):
    feature_setting = FeatureSetting.objects.filter(
        feature_name=MFFeatureSetting.STANDARD_PRODUCT_API_CONTROL
    ).last()
    if feature_setting:
        list_mfsp_partner = feature_setting.parameters.get('api_v1')
        parameters = {}
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(dukcapil_fr_threshold_leadgen_axiata, migrations.RunPython.noop),
    ]
