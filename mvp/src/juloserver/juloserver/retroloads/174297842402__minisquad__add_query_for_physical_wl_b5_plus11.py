...
def add_query_on_fs_physical_wl_b5_plus(apps, schema_editor):
    raw_query = """
        ...
        WHERE 
          dab.highest_dpd >= 120 and dab.highest_dpd <= 123
    ...
    """
    FeatureSetting.objects.filter(feature_name='wl_test').update( parameters={
            'physical_warning_letter': {
                'folder_id': '1IoK6na4RgZWvexyPenKba_wwNQ-Y5pab',
