# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2023-05-31 06:40
...
def add_cootek_configuration_for_jturbo(apps, schema_editor):
    ...
    cootek_configs = [
        {
            'strategy_name': 'JTurbo_JULO_T0', 'task_type': 'JTurbo_JULO_T0',
            ...
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '09:00:00'
        },
        {
            'strategy_name': 'JTurbo_JULO_T0', 'task_type': 'JTurbo_JULO_T0',
            ...
            'dpd_condition': 'Exactly', 'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '11:00:00'
        },
        {
            'strategy_name': 'JTurbo_JULO_T-1', 'task_type': 'JTurbo_JULO_T-1',
            ...
            'dpd_condition': 'Exactly', 'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '09:00:00',
        ...
        },
        {
            ...
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '11:00:00', 'exclude_risky_customer': True
        },
        {
            'strategy_name': 'JTurbo_JULO_T-1', 'task_type': 'JTurbo_JULO_T-1',
            'robot': robot_t_1, 'repeat_number': 3, 'called_at': -1,
            ...
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '13:00:00', 'exclude_risky_customer': True
        },
        {
            'strategy_name': 'JTurbo_JULO_T-1', 'task_type': 'JTurbo_JULO_T-1',
            ...
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '15:00:00', 'exclude_risky_customer': True
        },
        {
            'strategy_name': 'JTurbo_JULO_T-2', 'task_type': 'JTurbo_JULO_T-2',
            ...
            'dpd_condition': 'Exactly', 'product': CootekProductLineCodeName.JTURBO,
        },
        {
            'strategy_name': 'JTurbo_JULO_T-2', 'task_type': 'JTurbo_JULO_T-2',
            'robot': robot_t_2, 'repeat_number': 3, 'called_at': -2,
        ...
        },
        {
            ...
            'time_to_start': '12:00:00', 'time_to_query_result': '13:10:00',
            'time_to_prepare': '11:50:00', 'dpd_condition': 'Exactly',
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '13:00:00'
        },
        {
            'strategy_name': 'JTurbo_JULO_T-2', 'task_type': 'JTurbo_JULO_T-2',
            ...
            'time_to_start': '14:00:00', 'time_to_query_result': '15:10:00',
            'time_to_prepare': '13:50:00', 'dpd_condition': 'Exactly',
            'product': CootekProductLineCodeName.JTURBO, 'time_to_end': '15:00:00'
        },
    ]
