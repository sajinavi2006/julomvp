# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-09-09 09:42
...
def add_dbs_channeling_loan_configuration(apps, _schema_editor):
    ...
    if channeling_loan_configuration:
        channeling_loan_configuration.parameters[ChannelingConst.BNI] = {
            "is_active": True,
            "general": {
                ...
                "DAYS_IN_YEAR": 360,
                "CHANNELING_TYPE": ChannelingConst.HYBRID_CHANNELING_TYPE,
            },
            "rac": {
                "TENOR": "Monthly",
                "MAX_AGE": 59,
    ...
    channeling_loan_priority.parameters.append(ChannelingConst.BNI)
