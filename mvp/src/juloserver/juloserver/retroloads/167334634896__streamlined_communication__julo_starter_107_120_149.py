...
def retroload_julo_starter_infocard(_apps, _schema_editor):
    data_to_be_loaded = [
        {
            ...
            'additional_condition': 'JULO_STARTER_OFFER_TO_REGULAR',
        ...
        {
            'status': None,
            'additional_condition': 'JULO_STARTER_WAIT_VERIFICATION',
            'title': 'Datamu Sedang Diverifikasi ' + hourglass_emoji,
            'content': 'Prosesnya paling lama 1 jam aja, kok! '
                       '(Jika proses di hari Senin-Jumat pada jam 09.00 '
                       'hingga maksimum 17.00)',
            'button': [],
            'button_name': [],
            'click_to': [],
            'template_type': '2',
            ...
            'text_colour': '#ffffff',
            'title_colour': '#ffffff',
            'background_url': ImageNames.BG_120_149,
            'additional_images': [],
            'button_url': []
        }
    ]
    ...
    # upload image
    images_list = ('limit_max_julo_starter.png', 'button_107.png')
