# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-10-23 19:56
...
def add_smf_channeling_loan_configuration(apps, _schema_editor):
    ...
    if channeling_loan_configuration:
        channeling_loan_configuration.parameters[ChannelingConst.SMF] = {
            "is_active": False,
            "general": {
                "LENDER_NAME": "smf_channeling",
                "BUYBACK_LENDER_NAME": "blue_finc",
    ...
    channeling_loan_priority.parameters.append(ChannelingConst.SMF)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_smf_channeling_loan_configuration, migrations.RunPython.noop),
    ]
