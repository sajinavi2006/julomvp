# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2025-01-30 02:06
...
def add_query_on_fs_physical_wl(apps, schema_editor):
    raw_query = """
        WITH base_payment AS (
            SELECT DISTINCT 
                ...
                p.paid_date,
                p.paid_amount,
                CURRENT_DATE - p.due_date AS dpd,
        ...
        dab_summary AS (
            SELECT DISTINCT
                ...
                END AS bucket,
                COALESCE(
                SUM(CASE WHEN bap.due_date <= CURRENT_DATE THEN bap.due_amount ELSE NULL END),
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(add_query_on_fs_physical_wl, migrations.RunPython.noop)]
