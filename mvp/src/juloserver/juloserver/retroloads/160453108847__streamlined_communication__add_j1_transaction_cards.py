...
def retroload_cards_data_julo_one(_apps, _schema_editor):
    data_to_be_loaded = [
        {
            ...
            'content': 'Lanjutkan transaksi Anda sekarang sebelum pengajuanmu kadaluarsa.',
            'button': [],
            'click_to': [],
            'template_type': '2',
            'card_number': 1,
        ...
        },
        {
            ...
            'additional_condition': None,
            'title': 'Yuk, Lakukan Transaki Lagi!',
            ...
            'additional_images': [ImageNames.LAYER_2],
            'button_url': []
        }
    ]
    ...
    # upload image
    images_list = (
        'layer_2.png', 'layer_4.png', 'designs_real.png'
    )
