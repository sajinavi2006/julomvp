# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2023-05-25 01:56
...
def add_nexmo_robocall_jturbo(apps, schema_editor):
    dpd_message_content_map = {
        ...
        'dpd_+4': '[{"action": "talk", "voiceName": "Damayanti", "text": "Selamat {{greet}} {{name_with_title}}, '\
            'angsuran JULO Anda sebesar {{due_amount}} terlambat 4 hari. Segera lakukan pembayaran karena mulai besok, '\
            'Anda akan terkena denda. Terima kasih"}]',
    }
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_nexmo_robocall_jturbo, migrations.RunPython.noop),
    ]
