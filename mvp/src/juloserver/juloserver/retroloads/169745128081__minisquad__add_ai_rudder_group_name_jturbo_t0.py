# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2023-10-16 10:14
...
def add_bucket_jturbo_t0_to_ai_rudder_feature_setting(apps, schema_editor):
    ...
    eligible_jturbo_buckets = params['eligible_jturbo_bucket_number']
    eligible_jturbo_buckets.append(0)
    params['eligible_jturbo_bucket_number'] = eligible_jturbo_buckets
    ...
    params_threshold[DialerSystemConst.DIALER_JTURBO_T0] = 5000
    ...
    params_feature_group_config[DialerSystemConst.DIALER_JTURBO_T0] = "Group_Bucket JTturbo"
    ...
    feature_ai_rudder_tasks_config_params[DialerSystemConst.DIALER_JTURBO_T0] = t0_config
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(add_bucket_jturbo_t0_to_ai_rudder_feature_setting, migrations.RunPython.noop)
    ]
