# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2021-06-30 19:15
...
def create_pascal_lender(apps, schema_editor):
    ...
    if not user:
        ...
        user = User.objects.create_user("pascal", "adri@julo.co.id", password)
    ...
    if not partner:
        ...
        lender = LenderCurrent.objects.create(
            ...
            poc_position="CEO",
            source_of_fund="lainnya",
            lender_display_name='Pascal International',
            service_fee=0,
        ...
        for bank_account in jtp_bank_accounts:
            ...
            if bank_account.bank_account_type == BankAccountType.RDL:
                ...
                bank_account.account_name = "PASCAL INTERNATIONAL PTE LTD"
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(create_pascal_lender, migrations.RunPython.noop),
    ]
