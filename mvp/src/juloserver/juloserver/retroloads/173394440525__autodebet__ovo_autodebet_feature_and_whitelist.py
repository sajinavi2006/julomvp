...
def create_autodebet_and_whitelist_feature_ovo(apps, _schema_editor):
    ...
    FeatureSetting.objects.create(
        feature_name=FeatureNameConst.WHITELIST_AUTODEBET_OVO,
        parameters={"applications": []},
        is_active=False,
        category="repayment",
        description="Whitelist application who can use Autodebet OVO",
    )
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(
            create_autodebet_and_whitelist_feature_ovo, migrations.RunPython.noop
        ),
    ]
