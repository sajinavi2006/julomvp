# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2024-10-07 18:35
...
def create_abc_kredibel_fs(apps, _schema_editor):
    FeatureSetting.objects.get_or_create(
        feature_name='abc_kredibel',
        category="antifraud",
        description="Feature Flag for antifraud binary check Kredibel",
        is_active=False,
        parameters={
...
class Migration(migrations.Migration):
    ...
    operations = [migrations.RunPython(create_abc_kredibel_fs, migrations.RunPython.noop)]
